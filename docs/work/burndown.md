...
status: generated
source-updated: 2026-07-14T20:32:00Z
...
Data snapshot through `2026-07-14T20:32:00Z`.

## Summary

| Milestone | Open | Done | Ready | In progress | Blocked | Backlog | Sized points done/total | Unsized |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| M0: Architecture & Repository Baseline | 5 | 0 | 3 | 1 | 1 | 0 | 0/3 | 4 |
...
- [ ] [#128](https://github.com/jpalvarezl/blight-synth/issues/128) Integrate the modular-refactor branch into `main` and remove duplicate scaffolding — `ready`, `unsized`, unassigned
