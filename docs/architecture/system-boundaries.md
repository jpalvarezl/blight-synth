...
Current `audio_backend` still combines CPAL, `AudioProcessor`, tracker `Player`, OSC, and project hydration. The M0/M1 issues linked in frontmatter own the mechanical and semantic separation. Until they land, code and tests describe current behavior.
