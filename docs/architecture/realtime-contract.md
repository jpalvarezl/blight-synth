...
| Structural command work mixes notes, parameters, and graph updates | Overload semantics are conflated | #101/#134/#173/#174/#203/#204 | Partial. Bounded command work/reclamation landed (#173/#174), host-independent admission landed (#203), and #204 routes queued live note/release plus tracker playback through that lane. Coalesced continuous values and broader structural traffic separation remain #101. |
