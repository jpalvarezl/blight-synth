use eframe::egui::{self, KeyboardShortcut, Modifiers, Key};
...
pub mod shortcuts {
    ...
    pub const TOGGLE_PLAYBACK: KeyboardShortcut = KeyboardShortcut::new(Modifiers::NONE, Key::Space);
    pub const NEXT_TAB: KeyboardShortcut = KeyboardShortcut::new(Modifiers::CTRL, Key::Tab);
    pub const PREVIOUS_TAB: KeyboardShortcut = KeyboardShortcut::new(Modifiers::CTRL.plus(Modifiers::SHIFT), Key::Tab);
