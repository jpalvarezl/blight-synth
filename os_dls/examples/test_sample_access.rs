...
fn main() {
    ...
    let dls = load_mac_os_default().expect("Failed to load macOS DLS file");
    ...
    let sample_by_name = dls
        .get_sample_by_name("PIANO36")
    ...
    let sample_by_id = dls
        .get_sample_by_id(piano_entry.0)
